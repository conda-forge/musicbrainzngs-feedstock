...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/musicbrainzngs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15003&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/musicbrainzngs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `musicbrainzngs` can be installed with:

```
conda install musicbrainzngs
```

It is possible to list all of the versions of `musicbrainzngs` available on your platform with:
